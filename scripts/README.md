...
- Applies intelligent highlighting (🔥, 💪, 💰, ✅) based on actual metrics
...
### Option 2: Quick Update (using cached data) ⭐
```bash
...
| Category | Rule | Emoji |
|----------|-------|--------|
| Valuation (P/E, PEG, EV/EBITDA) | Lowest value | 🔥 |
| Growth (Revenue, Earnings) | Highest value | 📈 |
| Profitability (ROE, ROA, margins) | Highest value | 💪 |
| Cash | > $40B | 💰 |
| Debt/Equity | < 0.20 | ✅ |
| Current Ratio | > 2.0 | ✅ |
